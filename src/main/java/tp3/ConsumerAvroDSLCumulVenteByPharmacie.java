...
public class ConsumerAvroDSLCumulVenteByPharmacie implements Runnable {
    ...
    public ConsumerAvroDSLCumulVenteByPharmacie(String topic) {
        props = new Properties();
        props.put("bootstrap.servers","localhost:9092");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, CLIENT_ID);
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName());
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ByteArrayDeserializer.class.getName());
        props.put(StreamsConfig.APPLICATION_ID_CONFIG,"Application_ConsumerAvroDSLCumulVenteByPharmacie");
    ...
    public static void main(String[] args) {
        ConsumerAvroDSLCumulVenteByPharmacie consumerThread = new ConsumerAvroDSLCumulVenteByPharmacie("tp3");
        consumerThread.run();
